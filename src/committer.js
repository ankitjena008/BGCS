...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var getBase, getPublicKey, aliceBase, bobBase, reviewerKey, data, commit_id, encryptedData, _i, _a, _b, key, value, grantFields, temp;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    aliceBase = _c.sent();
                    return [4 /*yield*/, getBase("bob")];
                case 2:
                    bobBase = _c.sent();
                    return [4 /*yield*/, getPublicKey("bob")];
                case 3:
                    reviewerKey = _c.sent();
                    data = new Map();
                    commit_id = "commit_1";
